...
## 4. Register your from-source MCP server with Claude Code
...
For Codex, the same command and args go in `~/.codex/config.toml` — see
[`domain/skills-plugins.md`](domain/skills-plugins.md).
